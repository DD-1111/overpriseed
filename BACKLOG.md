...
### 13. "复刻挑战" 提交系统 ✅ DONE
**状态**: 已完成 (2026-04-06)
- [x] 允许用户提交自己的复刻项目 demo
- [x] 记录完成时间、人数、技术栈
- [x] 与原 deal 融资额对比，计算"真实成本"
- [x] 社区投票评选最佳复刻
...
### 2026-04-06 (中午 12:00)
- **复刻成本追踪系统**：P3-13 完成
  - 新增 `completion_days`, `team_size`, `tech_stack` 字段到 submissions 表
  - Migration 003_submission_cost_tracking.sql
  - 更新 POST /api/v1/submissions API 支持新字段
  - 前端提交表单添加成本追踪输入框
  - Submission 列表显示"真实成本" vs 融资额对比
  - 计算 "overpriced ratio" = 融资额 / (天数 × 人数 × $500/天)
  - ✅ 线上验证通过
